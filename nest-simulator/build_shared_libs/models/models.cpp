...
void nest::register_models()
{
  ...
  register_eprop_iaf( "eprop_iaf" );
  register_eprop_iaf_adapt( "eprop_iaf_adapt" );
  register_eprop_iaf_psc_delta( "eprop_iaf_psc_delta" );
  register_eprop_iaf_psc_delta_adapt( "eprop_iaf_psc_delta_adapt" );
  register_eprop_readout( "eprop_readout" );
  ...
  register_eprop_synapse( "eprop_synapse" );
  register_eprop_learning_signal_connection( "eprop_learning_signal_connection" );
